...
(function() {
  var $cached, ENDPOINT, ENVIRONMENT_MAX_INDEX, HEALTH_MAX_INDEX, MOCK_PRODUCT, SCREEN_WIDTH, cacheSelectors, calculateEnvironmentPercent, calculateHealthPercent, deviceready, displayError, displayProduct, displaySearchResults, fetchResult, gotoScreen, listEnvironmentRisks, listHealthRisks, listRisks, scan, screenIndex, search, serverWakeUp;
  ...
  displayProduct = function(product) {
    ...
    console.log(listRisks(product.R, _.defaults(window.RISK_PHRASES.ENVIRONMENT, window.RISK_PHRASES.HEALTH)));
